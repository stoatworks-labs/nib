...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "Line drawing for Resolume, steered by the drawing's own direction";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/nib/";
